...
const { SelectingGamepadEntity } = await import('./selectingGamepadEntity.js?ver='+window.srcVersion);
/*/
...
import SelectingGamepadEntity from './selectingGamepadEntity.js';
/**/
// begin code
...
// ************************ SMAZAT *************************
    ...
    switch (event.id) {
      ...
      case 'selectGamepad':
        this.addModalEntity(new SelectingGamepadEntity(this, 7, 18, 187, 67, this.selectedGamepad));
        return true;
